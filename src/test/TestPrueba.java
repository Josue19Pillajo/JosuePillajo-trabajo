...
import static test.TestEstudiante.datos;
import static test.TestEstudiante.llenaEstudiante;
...
public class TestPrueba {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" Porcentaje de  hombres + promedio " +porcentajePromedio (estudiantes, nroHombres,'m' ));
        System.out.println(" Porcentaje de mujeres + promedio " +porcentajePromedio (estudiantes, nroHombres,'f' ));
     ...
     public static void llenaEstudiante(Estudiante est []){
      ...
      public static double porcentajegenero(Estudiante est[]){
        ...
        return cuentahombres;public static double porcentajegenero(Estudiante est[]){
        int cuentahombres=0,cuentamujeres=0;
        double porc;
        for(int i=0;i<est.length;i++){
            if(est[i].getSexo()=='m'){
     ...
     public static double porcentajegenero(Estudiante est[], int nh, char sex){
        ...
        for(int i=0;i<est.length;i++) {
            if(est [i] getsexo()==sexo && est [i] getNota()>promedio) {
                cuenta ++ ;
            }
        }
        si (sexo == 'm') {
